...
<div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
     ...
     <option value="Dhaka">Cairo</option>
     <option value="Dhaka">Assuit </option>
     <option value="Dhaka">Alex </option>
     <option value="Dhaka">Aswan </option>
     <option value="Dhaka">sohag </option>
     <option value="Dhaka">Qena  </option>
     </select>
</div>
<div className="col-md-12 p-1 col-lg-12 col-sm-12 col-12">
