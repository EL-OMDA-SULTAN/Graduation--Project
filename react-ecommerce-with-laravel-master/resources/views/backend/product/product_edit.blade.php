                                        ...
                                        <div class="row g-3">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select name="category" class="form-select" id="inputProductType">
                                                    ...
                                                    @foreach($category as $item)
                                                        <option
                                                            value="{{ $item->category_name }}" {{ $item->category_name == $product->category ? 'selected': '' }} > {{ $item->category_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <select name="subcategory" class="form-select" id="inputProductType">
                                                    ...
                                                    @foreach($subcategory as $item)
                                                        <option
                                                            value="{{ $item->subcategory_name }}" {{ $item->subcategory_name == $product->subcategory ? 'selected': '' }} > {{ $item->subcategory_name }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark" type="checkbox"
                                                       value="FEATURED"
                                                       id="flexCheckDefault1" {{ $product->remark == 'FEATURED' ? 'checked' : '' }} >
                                            ...
                                            <div class="form-check">
                                                <input class="form-check-input" name="remark" type="checkbox"
                                                       value="COLLECTION"
                                                       id="flexCheckDefault3" {{ $product->remark == 'COLLECTION' ? 'checked' : '' }}>
